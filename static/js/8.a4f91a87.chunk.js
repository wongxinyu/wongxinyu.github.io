webpackJsonp([8],Array(554).concat([
/* 554 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__todo_css__ = __webpack_require__(1036);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__todo_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__todo_css__);
 ...
 */var TodoList=function(_Component){_inherits(TodoList,_Component);function TodoList(){var _ref;var _temp,_this,_ret;_classCallCheck(this,TodoList);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=TodoList.__proto__||Object.getPrototypeOf(TodoList)).call.apply(_ref,[this].concat(args))),_this),_this.state={meta:{page:1,per_page:10,total:0},todoList:[],hashNextpage:false},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(TodoList,[{key:"componentDidMount",value:function componentDidMount(){var _this2=this;var _state$meta=this.state.meta,page=_state$meta.page,per_page=_state$meta.per_page;this.getTodoList(page,per_page).then(function(todoList){_this2.setState({todoList:todoList,hashNextpage:todoList.length>0&&todoList.length>=per_page});});}},{key:"componentDidCatch",value:function componentDidCatch(err){console.error(err);}},{key:"getAllTodoList",value:function(){var _ref2=_asyncToGenerator(/*#__PURE__*/__WEBPACK_IMPORTED_MODULE_4_babel_runtime_regenerator___default.a.mark(function _callee(page,per_page){var todoList=arguments.length>2&&arguments[2]!==undefined?arguments[2]:[];var _ref3,data;return __WEBPACK_IMPORTED_MODULE_4_babel_runtime_regenerator___default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.next=2;return __WEBPACK_IMPORTED_MODULE_8__lib_github__["a" /* default */].issues.getForRepo({owner:__WEBPACK_IMPORTED_MODULE_9__config_json___default.a.owner,repo:__WEBPACK_IMPORTED_MODULE_9__config_json___default.a.todo_repo,filter:"created",state:"all",per_page:per_page,page:page,client_id:__WEBPACK_IMPORTED_MODULE_9__config_json___default.a.github_client_id,client_secret:__WEBPACK_IMPORTED_MODULE_9__config_json___default.a.github_client_secret});case 2:_ref3=_context.sent;data=_ref3.data;todoList=todoList.concat(data||[]);// 如果往后还有下一页，则继续请求，知道完为止
if(data.length>0&&data.length>=per_page){// todoList = await this.getAllTodoList(page + 1, per_page, todoList);
}return _context.abrupt("return",todoList);case 7:case"end":return _context.stop();}}},_callee,this);}));function getAllTodoList(_x2,_x3){return _ref2.apply(this,arguments);}return getAllTodoList;}()},{key:"getTodoList",value:function(){var _ref4=_asyncToGenerator(/*#__PURE__*/__WEBPACK_IMPORTED_MODULE_4_babel_runtime_regenerator___default.a.mark(function _callee2(page,per_page){var todoList;return __WEBPACK_IMPORTED_MODULE_4_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:this.setState({loading:true});_context2.next=3;return this.getAllTodoList(page,per_page);case 3:todoList=_context2.sent;this.setState({loading:false,hashNextpage:todoList.length>0&&todoList.length>=per_page});return _context2.abrupt("return",todoList);case 6:case"end":return _context2.stop();}}},_callee2,this);}));function getTodoList(_x4,_x5){return _ref4.apply(this,arguments);}return getTodoList;}()},{key:"getNextTodoList",value:function(){var _ref5=_asyncToGenerator(/*#__PURE__*/__WEBPACK_IMPORTED_MODULE_4_babel_runtime_regenerator___default.a.mark(function _callee3(){var _state$meta2,page,per_page,nextPage,nextTodoList,hash,newTodoList;return __WEBPACK_IMPORTED_MODULE_4_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:_state$meta2=this.state.meta,page=_state$meta2.page,per_page=_state$meta2.per_page;nextPage=page+1;_context3.next=4;return this.getTodoList(nextPage,per_page);case 4:nextTodoList=_context3.sent;if(nextTodoList.length){hash={};newTodoList=this.state.todoList.concat(nextTodoList).filter(function(v){if(!hash[v.id]){hash[v.id]=true;return true;}else{return false;}});this.setState({meta:Object.assign({},this.state.meta,{page:nextPage}),todoList:newTodoList});}case 6:case"end":return _context3.stop();}}},_callee3,this);}));function getNextTodoList(){return _ref5.apply(this,arguments);}return getNextTodoList;}()},{key:"render",value:function render(){var _this3=this;return __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("div",{className:"widget widget-todo"},__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("div",null,__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("h2",null,__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_react_router_dom__["b" /* NavLink */],{to:"/todo"},__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_antd_lib_icon___default.a,{type:"exception"}),"Todo"))),__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("ul",{className:"todo-list"},this.state.todoList.map(function(todo,i){var status=0;var statusText="未开始";var icon="undone";var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=(todo.labels||[])[Symbol.iterator](),_step;!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){var label=_step.value;switch(label.name){case"未开始":status=0;statusText="未开始";break;case"进行中":status=1;statusText="进行中";icon="doing";break;case"已完成":status=2;statusText="已完成";icon="done";break;case"暂搁置":status=3;statusText="暂搁置";icon="stop";break;case"已废弃":status=-1;statusText="已废弃";icon="cancel";break;default:}}}catch(err){_didIteratorError=true;_iteratorError=err;}finally{try{if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}}finally{if(_didIteratorError){throw _iteratorError;}}}return __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("li",{className:"todo-item"+" todo-"+icon,key:todo.title},__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7_react_router_dom__["b" /* NavLink */],{exact:true,to:"/todo/"+todo.number},todo.title));}),this.state.hashNextpage?__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("li",{className:"more"},__WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_antd_lib_button___default.a,{type:"default",loading:this.state.loading,onClick:function onClick(){return _this3.getNextTodoList();}},this.state.loading?"Loading":"More")):""));}}]);return TodoList;}(__WEBPACK_IMPORTED_MODULE_5_react__["Component"]);/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_6_redux_zero_react__["connect"])(function(state){return{};},__WEBPACK_IMPORTED_MODULE_10__redux_actions__["a" /* default */])(Object(__WEBPACK_IMPORTED_MODULE_7_react_router_dom__["e" /* withRouter */])(TodoList)));
...
// module
exports.push([module.i, "ul.todo-list .todo-item{padding:.8rem .5rem;-o-text-overflow:ellipsis;text-overflow:ellipsis;overflow:hidden;white-space:nowrap}ul.todo-list .todo-item:hover{background-color:#e5e5e5}ul.todo-list .todo-item a{color:#f4511e}.todo-done a{color:#43a047!important}", "", {"version":3,"sources":["W:/me/blogs/blog/src/widget/todo.css"],"names":[],"mappings":"AAAA,wBACE,oBAAuB,AACvB,0BAA2B,AACxB,uBAAwB,AAC3B,gBAAiB,AACjB,kBAAoB,CACrB,AAED,8BACE,wBAA0B,CAC3B,AAED,0BACE,aAAe,CAChB,AAED,aACE,uBAA0B,CAC3B","file":"todo.css","sourcesContent":["ul.todo-list .todo-item {\r\n  padding: 0.8rem 0.5rem;\r\n  -o-text-overflow: ellipsis;\r\n     text-overflow: ellipsis;\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n}\r\n\r\nul.todo-list .todo-item:hover {\r\n  background-color: #e5e5e5;\r\n}\r\n\r\nul.todo-list .todo-item a {\r\n  color: #f4511e;\r\n}\r\n\r\n.todo-done a {\r\n  color: #43a047 !important;\r\n}\r\n"],"sourceRoot":""}]);
